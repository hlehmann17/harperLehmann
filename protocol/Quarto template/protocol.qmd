...
read_csv(
  file = here("protocol/Quarto template", "0_tbl_amendments.csv"),
...
#| message: false
read_csv(
  file = here("protocol/Quarto template", "1_tbl_milestones.csv"),
  show_col_types = FALSE
  ) %>% 
  gt() %>% 
  gt_style()
...
#| layout-ncol: 1
read_csv(
  file = here("protocol/Quarto template", "2a_tbl_primary_objective.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  gt_style()
...
read_csv(
  file = here("protocol/Quarto template", "2b_tbl_secondary_objective.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  gt_style()
...
read_csv(
  file = here("protocol/Quarto template", "3_tbl_entry.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  gt_style()
...
read_csv(
  file = here("protocol/Quarto template", "4_tbl_inclusion.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  gt_style()
...
read_csv(
  file = here("protocol/Quarto template", "5_tbl_exclusion.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  gt_style()
...
read_csv(
  file = here("protocol/Quarto template", "6_tbl_exposure.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  tab_options(
...
read_csv(
  file = here("protocol/Quarto template", "7_tbl_outcome.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  tab_options(
...
read_csv(
  file = here("protocol/Quarto template", "8_tbl_follow_up.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  gt_style()
...
read_csv(
  file = here("protocol/Quarto template", "9_tbl_covariates.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  tab_options(
...
#| layout-ncol: 1
read_csv(
  file = here("protocol/Quarto template", "10a_tbl_primary_analysis.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  gt_style()
...
read_csv(
  file = here("protocol/Quarto template", "10b_tbl_secondary_analysis.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  gt_style()
...
read_csv(
  file = here("protocol/Quarto template", "11_tbl_sensitivity.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  gt_style()
...
#| out-width: 50%
read_csv(
  file = here("protocol/Quarto template", "12_tbl_data.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  gt_style()
