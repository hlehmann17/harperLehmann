...
format_gt(tbl_gt = tbl_milestones, img_file_path = tbl_file_path)
```
...
format_gt(tbl_gt = tbl_objectives1, img_file_path = tbl_file_path)
format_gt(tbl_gt = tbl_objectives2, img_file_path = tbl_file_path)
```
...
format_gt(tbl_gt = tbl_fu, img_file_path = tbl_file_path)
```
...
format_gt(tbl_gt = tbl_data, img_file_path = tbl_file_path) 
```
