...
For a table template to populate, please see protocol/1_tbl_amendments.csv
...
read_csv(
  file = here("protocol", "0_tbl_amendments.csv"),
  show_col_types = FALSE
  ) %>% 
  gt()

format_gt(tbl_gt = tbl_amendments, img_file_path = tbl_file_path)
```
...
For a table template to populate, please see protocol/2_tbl_milestones.csv
If used, set eva: false to eval: true
...
#| tbl-cap: "Milestones"
#| message: false
tbl_milestones <- read_csv(
  file = here("protocol", "1_tbl_milestones.csv"),
  show_col_types = FALSE
  ) %>% 
  gt()

format_gt(tbl_gt = tbl_milestones, img_file_path = tbl_file_path, zoom = 1)
```
...
#| layout-ncol: 1
tbl_objectives1 <- read_csv(
  file = here("protocol", "2a_tbl_primary_objective.csv"),
  show_col_types = FALSE
  ) %>%
  gt()

tbl_objectives2 <- read_csv(
  file = here("protocol", "2b_tbl_secondary_objective.csv"),
  show_col_types = FALSE
  ) %>%
  gt()

format_gt(tbl_gt = tbl_objectives1, img_file_path = tbl_file_path, zoom = 1)
format_gt(tbl_gt = tbl_objectives2, img_file_path = tbl_file_path, zoom = 1)
```
...
tbl_entry <- read_csv(
  file = here("protocol", "3_tbl_entry.csv"),
  show_col_types = FALSE
  ) %>%
  gt()

format_gt(tbl_gt = tbl_entry, img_file_path = tbl_file_path)
```
...
tbl_inclusion <- read_csv(
  file = here("protocol", "4_tbl_inclusion.csv"),
  show_col_types = FALSE
  ) %>%
  gt()

format_gt(tbl_gt = tbl_inclusion, img_file_path = tbl_file_path)
```
...
Details: An optional brief text description to provide more information about the exclusion criterion (e.g. age in years defined by (time 0 - year of birth)/365, baseline enrolment measured by Part A, B, D and no HMO insurance coverage with 30 day gaps allowed), 2 codes required
...
tbl_exclusion <- read_csv(
  file = here("protocol", "5_tbl_exclusion.csv"),
  show_col_types = FALSE
  ) %>%
  gt()

format_gt(tbl_gt = tbl_exclusion, img_file_path = tbl_file_path)
```
...
tbl_exposure <- read_csv(
  file = here("protocol", "6_tbl_exposure.csv"),
  show_col_types = FALSE
  ) %>%
  gt() %>% 
  tab_options(
...
tbl_exposure
#format_gt(tbl_gt = tbl_exposure, img_file_path = tbl_file_path)
```
...
tbl_outcome <- read_csv(
  file = here("protocol", "7_tbl_outcome.csv"),
  show_col_types = FALSE
  ) %>%
  gt()

format_gt(tbl_gt = tbl_outcome, img_file_path = tbl_file_path)
```
...
tbl_fu <- read_csv(
  file = here("protocol", "8_tbl_follow_up.csv"),
  show_col_types = FALSE
  ) %>%
  gt()

format_gt(tbl_gt = tbl_fu, img_file_path = tbl_file_path, zoom = 1)
```
...
tbl_covariates <- read_csv(
  file = here("protocol", "9_tbl_covariates.csv"),
  show_col_types = FALSE
  ) %>%
  gt()

format_gt(tbl_gt = tbl_covariates, img_file_path = tbl_file_path) 
```
...
#| layout-ncol: 1
tbl_primary_analysis <- read_csv(
  file = here("protocol", "10a_tbl_primary_analysis.csv"),
  show_col_types = FALSE
  ) %>%
  gt()

tbl_sec_analysis <- read_csv(
  file = here("protocol", "10b_tbl_secondary_analysis.csv"),
  show_col_types = FALSE
  ) %>%
  gt()

format_gt(tbl_gt = tbl_primary_analysis, img_file_path = tbl_file_path) 
format_gt(tbl_gt = tbl_sec_analysis, img_file_path = tbl_file_path) 
```
...
tbl_sensitivity <- read_csv(
  file = here("protocol", "11_tbl_sensitivity.csv"),
  show_col_types = FALSE
  ) %>%
  gt()

format_gt(tbl_gt = tbl_sensitivity, img_file_path = tbl_file_path) 
```
...
#| out-width: 50%
tbl_data <- read_csv(
  file = here("protocol", "12_tbl_data.csv"),
  show_col_types = FALSE
  ) %>%
  gt()

format_gt(tbl_gt = tbl_data, img_file_path = tbl_file_path, dpi = 100) 
```
```
